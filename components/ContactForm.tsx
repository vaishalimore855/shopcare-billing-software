...
//               {/* Office */}
//               <div className="bg-primary-light rounded-lg p-3 shadow-sm">
//                 {MOCK_CONTACT.filter((item) => item.Title === "Office").map(
//                   (item) => {
//                     let offices: string[] = [];
...
export function ContactForm({ getContact = [] }) {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Validate hearAboutOther if "Other" is selected
          ...
          >
            <div className="bg-primary/5 border border-primary/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-emerald-500 hover:from-blue-700 hover:to-emerald-600 text-white py-2.5 sm:py-3 text-base sm:text-lg font-semibold rounded-lg shadow-lg transition-all duration-300 cursor-pointer border-0"
                >
                  Send Message
                </button>
              </form>
