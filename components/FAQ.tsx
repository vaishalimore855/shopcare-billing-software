      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="space-y-4">
          {faqsToShow.map((faq, index) => (
            ...
            >
              <div
                className={`relative bg-white rounded-2xl shadow-md border transition-all duration-300 overflow-hidden hover:shadow-lg`}
              >
                {/* Question */}
                <button
                  onClick={() => setOpenIndex(openIndex === index ? -1 : index)}
        ...
        {/* {faqs.length > INITIAL_DISPLAY_COUNT && (
          <div className="text-center mt-6">
            <button
              ...
              className="px-6 py-2 border-0 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-xl font-semibold shadow-md hover:shadow-lg transition-all"
            >
          ...
          <div className="inline-flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-2xl p-6">
            ...
            >
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all"
              >
                Contact Support
              </motion.button>
            </a>
